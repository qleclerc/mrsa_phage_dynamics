...
levels(all_results_L$model) = c("Linear model", "Data", "Saturated model")
...
levels(all_results_beta$model) = c("Linear model", "Data", "Saturated model")
...
levels(all_results_both$model) = c("Linear model", "Data", "Saturated model")
